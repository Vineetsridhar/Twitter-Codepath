...
- [x] Use Parcelable instead of Serializable using the popular [Parceler library](http://guides.codepath.organdroid/Using-Parceler).
...
- I used PaperDB instead of SQLite
...
- [PaperDB](https://github.com/pilgr/Paper) - Persistant storage option for Android
